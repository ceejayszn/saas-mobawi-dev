...
class ExportService {
  ...
  static Future<void> printInvoice(
    ...
    String businessName = 'Euton Hotel',
  }) async {
  ...
  static Future<void> shareCsv(
    ...
    final file = File('${dir.path}/EutonHotel_Report_$periodLabel.csv');
    await file.writeAsString(csvData);
    await SharePlus.instance.share(ShareParams(
      files: [XFile(file.path)],
      text: 'Euton Hotel $periodLabel Report',
    ));
  }
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) => [
          ...
          pw.Row(
            ...
            children: [
              pw.Text(
                'Generated by MOBAWI LLC · Euton Hotel Admin POS',
      ...
      pw.Page(
        ...
        build: (pw.Context ctx) => pw.Column(
          ...
          children: [
            ...
            pw.Text('MOBAWI LLC · Euton Hotel', style: small, textAlign: centre),
            pw.SizedBox(height: 8),
          ],
        ),
      ),
